...
@section('content-admin')
    <section id="users-show" class="overflow-auto">
        <h3>{{ __('crud.info') }}</h3>
        ...
        <div class="bk-form" data-info="{{ __('base.data') }}">
            <div class="bk-form__wrapper">
                ...
                <div class="bk-form__field">
                    <label class="bk-form__label">{{ __('users.birthday') }}</label>
                    <div class="bk-form__text">{{ $user->birthday ? @getDMY($user->birthday) : __('crud.no_data') }}</div>
                </div>
